...
import { ProviderRegistry, envelopeContainsSecrets, } from "./provider-registry";
describe("provider secret resolution", () => {
    ...
    test("system-scoped invoke path resolves via the reserved system principal", async () => {
        ...
        await registry.invoke({ effectiveScope: "system", installationId: "inst-sys", kind: "sidecar", id: "tools" }, { input: "hello" }, { callerScope: "system", correlationId: "sys-invoke-1" });
