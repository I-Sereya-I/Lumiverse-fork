...
describe("worker image upload processing", () => {
    test("propagates thumbnail-processing opt-outs for single, bulk, and data-URL uploads", async () => {
        ...
        const invoke = (call) => new Promise((resolve) => {
        ...
        try {
            ...
            const dataUrlResponse = await invoke((api) => api.handleImagesUploadFromDataUrl("data-url", "data:image/png;base64,AQIDBA==", "data-url.png", undefined, undefined, true));
