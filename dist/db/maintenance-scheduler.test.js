...
import { startAutomaticDatabaseMaintenance, stopAutomaticDatabaseMaintenance, } from "./maintenance-scheduler";
import { resetEditAndSendDispatcherForTests, setEditAndSendGenerationActiveCheck, setEditAndSendStartGeneration, } from "../services/edit-and-send-dispatcher.service";
...
describe("automatic maintenance outbox sweep", () => {
    test("tick re-dispatches a claimed row reset to pending by reconciliation", async () => {
        ...
        startAutomaticDatabaseMaintenance(() => getDb(), () => null, () => ":memory:", () => null, async (_name, fn) => fn(), 10);
