...
export class OpenAIImageProvider {
    ...
    async requestGeneration(apiKey, apiUrl, model, request) {
    ...
    async requestEdit(apiKey, apiUrl, model, request, sources) {
        const params = request.parameters;
     ...
     */
    buildCommonBody(model, request, operation) {
        const params = request.parameters;
        const body = { model, prompt: request.prompt, n: 1 };
