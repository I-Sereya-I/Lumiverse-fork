export const EXPRESSION_VARIANTS = [
    {
        ...
        cues: "A calm, at-rest face: mouth closed and level, brows relaxed, eyes open with a soft, steady gaze.",
    },
    {
        id: "happy",
        tags: "smile, happy, cheerful",
        negative_tags: "tears, crying, angry, frown, sad",
        cues: "A genuine smile: the corners of the mouth raised, cheeks lifted, eyes gently narrowed with warmth, brows relaxed.",
    },
    {
        id: "sad",
        tags: "sad, frown, furrowed brow, downcast eyes",
        negative_tags: "tears, crying, sobbing, smile, open mouth",
        cues: "Clear sadness: the inner ends of the brows raised and drawn together, mouth corners turned down, eyelids heavy, gaze lowered. No tears.",
    },
    {
        id: "angry",
        tags: "angry, glaring, furrowed brow, frown",
        negative_tags: "smile, tears, crying, blush, shouting, open mouth",
        cues: "Open anger: brows pulled down and together, eyes narrowed into a hard glare, jaw set, mouth pressed thin.",
    },
    {
        id: "surprised",
        tags: "surprised, wide-eyed, raised eyebrows, parted lips",
        negative_tags: "smile, tears, screaming, scared",
        cues: "Sudden surprise: brows raised high, eyes wide open, lips parted in a small gasp.",
    },
    {
        id: "afraid",
        ...
        cues: "Visible fear: brows raised and drawn together, eyes wide with the upper lids lifted, lips parted and pulled back at the corners.",
    },
    {
        id: "disgust",
        tags: "disgust, frowning, narrowed eyes, wrinkled nose, wavy mouth",
        negative_tags: "smile, tears, vomit, tongue out",
        cues: "Plain disgust: nose wrinkled, upper lip raised, brows lowered, eyes narrowed, the head drawn back slightly.",
    },
    {
        id: "shy",
        ...
        cues: "Shy embarrassment: a soft blush on the cheeks, gaze averted to the side and down, a small hesitant mouth, brows tilted up at the inner ends.",
    },
];
export function resolveExpressionVariant(label) {
...
export function buildExpressionEditPrompt(variant) {
    return [
...
export function buildExpressionTagPrompts(variant, basePrompt, baseNegative) {
    return {
        prompt: joinTags(variant.tags, basePrompt),
        negative_prompt: joinTags(variant.negative_tags, baseNegative),
    };
}
export function composeExpressionPrompts(variant, mechanism, basePrompt, baseNegative) {
    if (mechanism === "edit") {
