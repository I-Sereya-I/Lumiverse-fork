...
function hasRelationalAxis(spine) {
    return Boolean(spine.entries.find((e) => e.slot === "relational_axis")?.content.trim());
}
export function buildGovernanceEntries(spine) {
    const entries = [
