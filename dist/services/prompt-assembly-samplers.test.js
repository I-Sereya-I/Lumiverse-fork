...
function samplerOverrides(overrides = {}) {
    return {
        enabled: true,
        maxTokens: null,
        contextSize: null,
...
describe("sampler parameter assembly", () => {
    ...
    test("applies the reasoning custom body instead of the legacy preset body", () => {
        ...
        const parameters = buildParameters(null, preset, {
