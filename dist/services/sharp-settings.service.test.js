...
import { applySharpSettings, getSharpSettingsStatus, normalizeSharpSettings, releaseSharpCacheMemory, } from "./sharp-settings.service";
...
describe("Sharp cache pressure handling", () => {
    ...
    test("rejects unsupported thumbnail codecs and clamps quality values", () => {
        expect(() => normalizeSharpSettings({ thumbnailCodec: "jpeg" })).toThrow("Thumbnail codec must be webp, avif, or null");
