...
import { CORTEX_SIDECAR_CIRCUIT_FAILURE_THRESHOLD, decideCortexSidecarFallback, isTransientCortexSidecarError, recordCortexSidecarCircuitOpenForTests, resetCortexSidecarCircuitForTests, runQueryGenerationSidecar, } from "./index";
import { DEFAULT_CORTEX_CONFIG, normalizeCortexConfig } from "./config";
    ...
    test("fails over to tertiary after primary and secondary exhaust", async () => {
        ...
        const decision = await runQueryGenerationSidecar({
            ...
            extract: async (target) => {
                ...
                if (target.connectionProfileId !== "tertiary-conn")
