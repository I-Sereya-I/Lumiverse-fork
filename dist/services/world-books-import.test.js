...
import { countImportedWorldBookEntries, materializeCharacterBookEntriesForRuntime, normalizeImportedEntryInput, } from "./world-books.service";
describe("character book import normalization", () => {
    test("counts object-keyed embedded entries", () => {
        expect(countImportedWorldBookEntries({
