...
import { applyInlineWebSearchContextSlots, captureInlineWebSearchContextSlot, formatInlineWebSearchContext, INLINE_WEB_SEARCH_MAX_RESULTS, INLINE_WEB_SEARCH_MAX_QUERY_CHARS, INLINE_WEB_SEARCH_CONTEXT_SLOT_MARKER, INLINE_WEB_SEARCH_TOOL, prepareInlineWebSearchMessagesForProvider, } from "./inline-web-search";
describe("inline web search", () => {
    test("defines a bounded, strict web-search function", () => {
        ...
        const schema = INLINE_WEB_SEARCH_TOOL.parameters;
