...
export function worldBookVectorDesiredStatusSql(alias) {
    return `CASE WHEN ${worldBookVectorEligibilitySql(alias)} THEN 'pending' ELSE 'not_enabled' END`;
}
export function worldBookVectorStateDriftSql(alias) {
...
export function worldBookVectorTrackingFingerprint(entry) {
...
export function worldBookVectorSettingsFingerprint(settings) {
    return JSON.stringify({
