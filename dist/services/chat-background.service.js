 ...
 */
const chatBackgroundControllers = new Map();
...
const chatBackgroundTasks = new Map();
function chatBgKey(userId, chatId) {
 ...
 */
export function getChatBackgroundSignal(userId, chatId) {
 ...
 */
export function trackChatBackgroundTask(userId, chatId, task) {
    const key = chatBgKey(userId, chatId);
...
export async function abortChatBackground(userId, chatId) {
    const key = chatBgKey(userId, chatId);
...
export function abortUserBackgrounds(userId) {
    const prefix = `${userId}:`;
...
export function abortAllBackgrounds() {
