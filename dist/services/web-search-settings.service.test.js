...
const { EXA_WEB_SEARCH_API_KEY_SECRET, TAVILY_WEB_SEARCH_API_KEY_SECRET, WEB_SEARCH_API_KEY_SECRET, WEB_SEARCH_SETTINGS_KEY, getWebSearchApiKey, putWebSearchSettings, } = await import("./web-search-settings.service");
beforeEach(() => {
    settings.clear();
    secrets.clear();
...
describe("web-search settings credentials", () => {
    ...
    ])("stores the %s credential as a user-scoped encrypted secret", async (provider, secretKey) => {
