...
import { insertBlocksIntoTaggedHistory, resolveChatHistoryInsertionIndex, } from "./prompt-assembly.service";
function makeMessage(role, content, chatHistory = false) {
    const msg = { role, content };
    if (chatHistory) {
        msg.__chatHistorySource = true;
    }
    return msg;
}
