...
const TINY_PNG_DATA_URL = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQIHWP4//8/AwAI/AL+Xn1mAAAAAElFTkSuQmCC";
let captured = [];
const fakeProvider = {
    name: PROVIDER_NAME,
...
async function seedChatWithAssistantReply(userId) {
