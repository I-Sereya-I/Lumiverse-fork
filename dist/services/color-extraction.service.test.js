...
import { contrastRatio, extractColorsFromRawPixels, rgbToHsl, } from "./color-extraction.service";
...
describe("extractColorsFromRawPixels", () => {
    ...
    test("derives readable text and button colors for both UI surfaces", () => {
        const data = makeImage(12, 12, (x, y) => {
            if (x < 4)
                return { r: 38, g: 44, b: 92 };
            if (x < 8)
                return { r: 118, g: 74, b: 180 };
