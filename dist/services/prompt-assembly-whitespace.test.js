...
import { evaluate, initMacros, registry } from "../macros";
import { attributeExpandedMarkerWorldInfoTokens, evaluatePromptBlockTokenCountContent, normalizePromptBlockText, } from "./prompt-assembly.service";
function makeEnv() {
    return {
        commit: false,
        names: {
...
After
        ...
        expect(normalizePromptBlockText(raw)).toBe("<self_reasoning>\nAlright.\n\nAfter\n</self_reasoning>");
    });
