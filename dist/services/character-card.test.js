...
import { detectCharacterImportFormat, extractCardFromPng, normalizeJannyCharacterInput, resolveInlineAssetReferences, } from "./character-card.service";
...
describe("character card import format detection", () => {
    test("prefers PNG bytes over incorrect mobile MIME metadata", async () => {
        ...
        const pngWithCard = embedPngTextChunk(Buffer.from(ONE_BY_ONE_PNG_BASE64, "base64"), "ccv3", Buffer.from(cardJson, "utf-8").toString("base64"));
