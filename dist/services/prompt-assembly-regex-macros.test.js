...
import { isChatHistoryMessage, isWorldInfoEntryMessage, resolvePromptMacrosAfterRegexPass, } from "./prompt-assembly.service";
function makeEnv() {
    return {
        commit: true,
        names: {
...
function markChatHistory(message) {
    message.__chatHistorySource = true;
    return message;
}
function markWorldInfo(message) {
    message.__worldInfoSource = true;
    return message;
}
