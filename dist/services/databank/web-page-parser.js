 ...
 */
export function parseWebPage(html, url) {
    try {
        ...
        if (!article) {
            throw new WebPageParseError("Could not extract article content from page", "no_content");
        }
        ...
        if (err instanceof WebPageParseError)
            throw err;
