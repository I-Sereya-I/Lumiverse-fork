...
import { deleteDocument, updateDatabank, updateDocumentStatus, } from "./databank-crud.service";
import { getCachedDatabankResult, resetDatabankCacheForTests, setCachedDatabankResult, } from "./retrieval-cache.service";
const cachedResult = {
    chunks: [],
    formatted: "deleted document content",
    count: 1,
};
function seedBankAndDocument() {
    const db = getDb();
