 ...
 */
export function registerListMacros() {
    ...
    registry.registerMacro({
        ...
        name: "range",
        category: "Iteration",
        description: "Generate a numeric sequence as a comma-separated list. {{range::5}} → 1, 2, 3, 4, 5. " +
    ...
    registry.registerMacro({
        ...
        name: "includes",
        category: "Lists",
        description: "'true' if the list contains the item (whole-item, case-sensitive match), else ''. Usable as a condition.",
        returnType: "boolean",
        args: [
    ...
    registry.registerMacro({
        ...
        name: "slice",
        category: "Lists",
        description: "Sublist from start to end (end exclusive, optional). Negative indices count from the end. " +
    ...
    registry.registerMacro({
        ...
        name: "sort",
        category: "Lists",
        description: "Sort a list. Numeric when every item is a number, otherwise alphabetical. " +
        ...
        handler: (ctx) => {
            ...
            const allNumeric = items.length > 0 && items.every((x) => x.trim() !== "" && !isNaN(Number(x)));
            const sorted = [...items].sort(allNumeric ? (a, b) => Number(a) - Number(b) : (a, b) => a.localeCompare(b));
            if (dir === "desc" || dir === "descending" || dir === "reverse")
                sorted.reverse();
