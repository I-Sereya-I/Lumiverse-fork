...
export function registerRandomMacros() {
    registry.registerMacro({
        ...
        name: "random",
        category: "Random",
        description: "Random integer between min and max (inclusive), or pick a random item from a list of strings",
        returnType: "string",
        args: [
        ...
        handler: (ctx) => {
            ...
            const allNumeric = ctx.args.length <= 2 &&
