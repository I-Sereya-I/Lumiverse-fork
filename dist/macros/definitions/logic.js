...
export function registerLogicMacros() {
    registry.registerMacro({
        ...
        name: "switch",
        category: "Logic",
        description: "Multi-branch conditional. {{switch::value::case1::result1::case2::result2::default}}",
        returnType: "string",
        isList: true,
    ...
    registry.registerMacro({
        ...
        handler: async (ctx) => {
            ...
            for (let i = 0; i < ctx.rawArgs.length; i++) {
                if (!isTruthy(await resolveArg(ctx, i)))
                    return "";
            }
            return "true";
        },
