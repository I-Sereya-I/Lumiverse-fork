...
function findComparisonOperator(value) {
    let bestIndex = -1;
    let bestOp = null;
 ...
 */
export function isConditionTruthy(value) {
 ...
 */
function resolveInlineShorthands(condition, variables) {
    return condition
 ...
 */
export function evaluateMacroCondition(condition, variables) {
