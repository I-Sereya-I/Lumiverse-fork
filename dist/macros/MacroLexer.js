...
function lexMacroContent(input, start, len, tokens) {
    let pos = start;
    // Skip whitespace
 ...
 */
function lexArgument(input, start, len, tokens) {
    let pos = start;
    let textStart = pos;
    while (pos < len) {
 ...
 */
function lexSpaceDelimitedArgs(input, start, len, tokens) {
    let pos = start;
    while (pos < len) {
 ...
 */
function lexSpaceArg(input, start, len, tokens) {
    let pos = start;
    let textStart = pos;
    while (pos < len) {
        // Handle escaped braces
...
function lexOperator(input, start, len, tokens) {
    let pos = start;
    if (pos >= len)
        return pos;
    // Two-char operators
