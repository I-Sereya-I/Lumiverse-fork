...
import { GuidedReasoningStreamParser, closeUnterminatedDelimitedReasoning, extractDelimitedReasoning, resolveReasoningDelimiters, separateDelimitedReasoning, wrapDelimitedReasoningStream, } from "./reasoning-strip";
...
describe("reasoning delimiter helpers", () => {
    ...
    test("separates tagged CoT from visible content and preserves provider reasoning", () => {
        expect(separateDelimitedReasoning("Answer<think>plan</think>", "native", { prefix: "<think>", suffix: "</think>" }, true)).toEqual({
            content: "Answer",
            reasoning: "native\nplan",
        });
    });
