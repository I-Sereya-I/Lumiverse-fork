...
export function parseBotBooruId(url) {
    let parsed;
    try {
    ...
    if (parsed.protocol !== "http:" && parsed.protocol !== "https:")
        return null;
    if (!BOTBOORU_HOSTS.has(parsed.hostname.toLowerCase()))
        return null;
...
export function botBooruDownloadUrl(id, format) {
 ...
 */
export function rewriteBotBooruUrl(url, format) {
