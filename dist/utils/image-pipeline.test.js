...
import { convertImageToPng, readImageMetadata, resizeInsideToWebp, writeInsideAvif, writeInsideWebp, } from "./image-pipeline";
...
describe("Bun-native image pipeline", () => {
    ...
    test("falls back to Sharp for formats outside Bun.Image", async () => {
        const svg = Buffer.from('<svg xmlns="http://www.w3.org/2000/svg" width="12" height="8"><rect width="12" height="8" fill="red"/></svg>');
