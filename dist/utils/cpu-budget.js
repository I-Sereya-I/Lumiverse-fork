...
export function logicalThreadCount(available = availableParallelism) {
    try {
        const n = available();
 ...
 */
export function deriveWorkerBudget(logicalThreads = logicalThreadCount(), reserved) {
...
export function currentWorkerBudget() {
 ...
 */
export function deriveThumbnailSharpConcurrency(codec, cpuDerivedConcurrency = currentWorkerBudget().sharpConcurrency) {
...
export function setWorkerBudgetOverride(budget) {
