...
export function getRequiredTerminalLiteral(pattern) {
    let suffix = "";
    let depth = 0;
 ...
 */
export function getRegexSearchEnd(input, pattern, flags, replacementTemplate) {
    if (replacementTemplate.includes("$'"))
        return input.length;
