...
describe("remote-image-page", () => {
    test("prefers og/twitter image metadata from shared page URLs", () => {
        ...
        expect(extractRemoteImageUrlFromHtml("https://tenor.com/view/example-gif-123", html)).toBe("https://media.tenor.com/abc123/tenor.gif");
    });
    test("resolves relative metadata URLs against the page URL", () => {
        ...
        expect(extractRemoteImageUrlFromHtml("https://example.com/posts/demo", html)).toBe("https://example.com/images/preview.webp");
    });
    test("falls back to image tags when metadata is absent", () => {
        ...
        expect(extractRemoteImageUrlFromHtml("https://example.com/post", html)).toBe("https://cdn.example.com/animated/banner.webp");
    });
