...
function insertPreset(id, userId, cacheRevision = 0) {
    getDb().run(`INSERT INTO presets (id, name, provider, parameters, prompt_order, metadata, created_at, updated_at, prompts, user_id, engine, cache_revision)
     VALUES (?, 'Preset', 'loom', '{}', '[]', '{}', 1, 1, '{}', ?, 'classic', ?)`, [id, userId, cacheRevision]);
}
const app = new Hono();
