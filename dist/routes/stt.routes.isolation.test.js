...
const { listProviders, getProvider, } = await import("../services/stt-connections.service");
...
describe("stt routes multi-tenant isolation", () => {
    ...
    test("denied or unloaded installations disappear from every user's listing", async () => {
        providerRegistry.register({ kind: "stt", id: "denied-stt", description: { denied: true } }, aliceHost);
