...
import { resetEditAndSendDispatcherForTests, setEditAndSendStartGeneration, getGenerationOutboxByRequest, } from "../services/edit-and-send-dispatcher.service";
const USER_ID = "user-1";
function initRouteTestDb() {
    closeDatabase();
    initDatabase(":memory:");
    const db = getDb();
...
function seedHistory() {
    ...
    const insert = getDb().query(`INSERT INTO messages (
